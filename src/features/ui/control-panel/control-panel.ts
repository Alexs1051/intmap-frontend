    ...
    private createButtons(): void {
        const buttonsConfig: Array<{
            ...
            type: UIEventType;
                ...
                { id: 'search', defaultIcon: 'icons/ui/search.png', tooltip: 'Поиск', type: UIEventType.SEARCH_TOGGLE },
                { id: 'auth', defaultIcon: 'icons/ui/lock.png', activeIcon: 'icons/ui/lock-open.png', tooltip: 'Не авторизован', type: UIEventType.AUTH_TOGGLE }
            ];
