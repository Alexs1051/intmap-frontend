...
export class MarkerDetailsPanel implements IMarkerDetailsPanel {
    ...
    private updateContent(marker: Marker): void {
        ...
        // Название с иконкой - используем геттеры маркера, а не raw data
        this._contentContainer.appendChild(this.createTitleSection(marker, data));
    ...
    private createTitleSection(marker: Marker, data: MarkerData): HTMLDivElement {
        ...
        const bgColor = marker.backgroundColor;
